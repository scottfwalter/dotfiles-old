...
create_dir_link "$BASE_DIR/dotfiles/.starship-config" "$HOME/.startship-config"
...
create_file_link "$BASE_DIR/dotfiles/.zshrc_cxone" "$HOME/.zshrc_cxone"
...
create_file_link "$BASE_DIR/dotfiles/.zshrc.local" "$HOME/.zshrc.local"
